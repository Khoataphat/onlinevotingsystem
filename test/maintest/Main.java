...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        initComponents();
        setSize(800, 600); // Thiết lập kích thước cửa sổ là 800x600 pixels
        ...
        slide.setAnimate(5);
        slide.init(login, register, welcomeui);
        welcomeui.addEventContinue(new ActionListener() {
            @Override
        ...
        welcomeui.addEventBackLogin(new ActionListener() {
        @Override
        public void actionPerformed(ActionEvent ae) {
            slide.show(0);
            register.register();
    ...
    private void initComponents() {
        ...
        panelGradiente1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelGradiente1Layout.createSequentialGroup()
                ...
                .addComponent(panelBorder1, javax.swing.GroupLayout.PREFERRED_SIZE, 539, javax.swing.GroupLayout.PREFERRED_SIZE)
